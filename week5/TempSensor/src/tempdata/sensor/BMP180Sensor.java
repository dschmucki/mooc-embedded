...
public class BMP180Sensor extends I2CSensor {
     ...
     */
    public BMP180Sensor() throws IOException {
        super(BMP180_ADDR);
        initDevice();
    }
     ...
     * @throws java.io.IOException
     */
    public BMP180Sensor(int i2cBus, int address, int addressSizeBits, int serialClock) throws IOException {
    ...
    private void initDevice() {
        try {
            ...
            System.out.println("BMP180Sensor: initDevice: " + e.getMessage());
    ...
    public void gettingCalibration() throws IOException {
        ...
        if (result < callibrationBytes) {
            System.out.println("BMP180Sensor: gettingClibrarion: Not all the callibration bytes were read");
            return;
        }
