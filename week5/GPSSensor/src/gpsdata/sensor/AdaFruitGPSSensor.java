 ...
 * @author Simon Ritter
 */
public abstract class AdaFruitGPSSensor implements GPSSensor, Messages, AutoCloseable {
    ...
    public Velocity getVelocity() throws IOException {
        ...
        while (true) {
            ...
            try {
                speed = Double.parseDouble(fields.get(5));
            } catch (NumberFormatException nfe) {
        ...
        printMessage("speed = " + fields.get(5), DATA);
